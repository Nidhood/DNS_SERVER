...
public class DNS_response {
    ...
    byte[] respuesta = new byte[1024];
        ...
        // Recibimos el encabezado:
        DataInputStream dataInputStream = new DataInputStream(new ByteArrayInputStream(respuesta));

        // Podemos leer el id como el primer short del input:
        Short ID = dataInputStream.readShort();

        // En este caso queremos leer las banderas por separado:
        short banderas = dataInputStream.readByte();
        int QR = (banderas & 0b10000000) >>> 7;
